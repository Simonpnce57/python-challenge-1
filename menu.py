...
print("Welcome to Yellow Bus Eaterie .")
...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Enter Menu Number. ")
        ...
        # 4. Check if the menu selection is in the menu items
            if menu_item_number in menu_items.keys():
                ...
                #reference item name and integer for quantity.
            ...
            print("Customer your input isn't valid. ")

                # Tell the customer they didn't select a menu option

        else:
            print("You did not select a menu option, plaese select menu option. ")
            # Tell the customer they didn't select a menu option
